...
**ClearCut override:** Make minimal fixes with native HTML and the custom primitives represented in `misc/clearcut-flow/`. Do not introduce shadcn, Radix, React Aria, or icon-library dependencies; preserve both themes and the mock's interaction patterns.
