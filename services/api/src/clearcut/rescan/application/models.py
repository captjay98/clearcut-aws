...
class RevisionPlan:
    ...
    carry-forward; ``affected_element_ids`` are the after-version elements that
    require fresh detection (modified/added); ``removed_element_ids`` are
    before-version elements that stay historical only.
    """
